...
/* ACCION 4: Equipo a Escuela (CASCADE)
Primero borrar Entrenamiento para CASCADE borre Participante y Recibe
Luego borrar Inscripcion y Pago que refencian Escuela 
Finalmente borrar Escuela que CASCADE borra Equipo*/
DELETE FROM Entrenamiento WHERE idEntrenamiento = 400;
