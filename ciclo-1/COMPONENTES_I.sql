...
CREATE OR REPLACE PACKAGE BODY PK_AUDITORIAS AS
  ...
  BEGIN
    INSERT INTO Auditoria (idUsuario, tipoAccion, tabla, idRegistro, valorAntes, valorDespues, fechaHora)
    VALUES (p_idUsuario, p_tipoAccion, p_tabla, p_idRegistro, p_valorAntes, p_valorDespues, p_fechaHora);
    COMMIT;
